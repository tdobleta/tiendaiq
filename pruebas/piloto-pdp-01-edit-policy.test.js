...
function document() {
  ...
  return { global: { template: { id: "piloto/pdp-01", version: 1 }, estilo: "piloto-pdp-01" }, fuente: { shopify_product_id: source_fields.product_gid }, piloto_pdp_01: { contract_version: 1, template: "piloto-pdp-01", source_fields, source_hash: hashSource(source_fields), evidence: {}, content: { hero: { claim: "Una idea simple", bullets: ["Beneficio uno", "Beneficio dos"] }, offer: { heading: "Opciones", packs: [{ id: "unidad", label: "Una unidad", subtitle: "Para empezar", quantity: 1, mechanism: "multi_quantity", variant_id: "gid://shopify/ProductVariant/1" }] }, why: { eyebrow: "Rutina", heading: "Elegí con claridad", body: "Información del producto", points: ["Punto uno", "Punto dos"] }, timeline: { heading: "Recorrido", intro: "Guía", steps: [{ label: "Paso uno", heading: "Conocé", body: "Revisá" }, { label: "Paso dos", heading: "Elegí", body: "Seleccioná" }] }, faq: { heading: "Preguntas", items: [{ question: "¿Cómo?", answer: "Revisá." }, { question: "¿Qué?", answer: "La ficha." }, { question: "¿Dónde?", answer: "En Shopify." }] }, media: { hero_media_id: "gid://shopify/MediaImage/1", gallery_media_ids: ["gid://shopify/MediaImage/1"] } } } };
}
