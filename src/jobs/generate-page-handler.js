...
function createGeneratePageHandler({ sessions, generations, pages, generate, metrics, finalizeRetryMs = 250 }) {
  return Object.freeze({
    ...
    async run(job, { signal } = {}) {
      const { reservationId, productId, idioma = "es", angulo = "", estilo = "section-page-v1", requestId = null, intentionFingerprint = null } = job.payload || {};
      ...
      try {
        ...
        const page = {
          ...
          generacion: {
            ...
            ...(intentionFingerprint ? { intencion_hash: String(intentionFingerprint) } : {})
          },
          url_publica: null,
