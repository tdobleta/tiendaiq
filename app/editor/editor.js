...
function montarEditor(raiz, { documento: docInicial, producto = null, alGuardar = null, alPublicar = null, alSubirImagen = null, rutaCss, titulo = "Página de producto", subtitulo = "Editor" } = {}) {
  ...
  flota.addEventListener("click", (evento) => {
    ...
    switch (accion.dataset.accion) {
      ...
      case "ia": return void raiz.dispatchEvent(new CustomEvent("tiq:ia", { detail: { nodo }, bubbles: true }));
    }
  });
