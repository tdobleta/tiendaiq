...
Me llegó en 3 días y funciona tal cual el video."></textarea>
  ...
  function pantallaPreview() {
    ...
    const resetEditorScroll = () => { window.scrollTo(0, 0); document.documentElement.scrollTop = 0; if (document.body) document.body.scrollTop = 0; const canvas = document.querySelector('.pe-canvas-viewport'); if (canvas) canvas.scrollTo(0, 0); };
